...
enum class ModelProfiles(val profile: ModelProfile) {
    ...
    ULTRA_LIGHT(
        ModelProfile(
            ...
            sttSize = 75,
            llmModel = "Qwen2 0.5B",
            llmFile = "qwen2-0_5b-instruct-q4_k_m.gguf",
            llmRepo = "Qwen/Qwen2-0.5B-Instruct-GGUF",
            llmSize = 400,
    ...
    STANDARD(
        ModelProfile(
            ...
            sttSize = 460,
            llmModel = "Qwen2 1.5B",
            llmFile = "qwen2-1_5b-instruct-q4_k_m.gguf",
            llmRepo = "Qwen/Qwen2-1.5B-Instruct-GGUF",
            llmSize = 950,
    ...
    HIGH(
        ModelProfile(
            ...
            sttSize = 1550,
            llmModel = "Qwen2 7B",
            llmFile = "qwen2-7b-instruct-q4_k_m.gguf",
            llmRepo = "Qwen/Qwen2-7B-Instruct-GGUF",
            llmSize = 4300,
